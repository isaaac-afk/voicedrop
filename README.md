...
Engineered a fully offline voice dictation tool to replace  commercial software, with real-time silence detection, threading-safe audio capture, and Whisper hallucination filtering. Built as a free alternative to WisprFlow using OpenAI's Whisper model running fully locally.
